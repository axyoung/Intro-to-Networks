...
# This program connects to the wireshark labs and reads in a small message
# Author: Alex Young
# Date: 4/12/2021
...
REQ = bytes(REQUEST_1, 'utf-8')     # Change the request into bytes for the sendall to use
HOST = "gaia.cs.umass.edu"
